  ...
  return (
    <article className="donation-card">
      ...
      <div className="card-body">
        <span className={`card-tag ${tagClasses[donation.type] || ''}`}>{donation.tag}</span>
      ...
      <div className="card-footer">
        <div className="card-actions">
          ...
          <button className="action-btn" type="button" onClick={() => onRequest(donation)}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
              <path d="M12 20h9" />
        ...
        <button className="btn-solicitar" type="button" onClick={() => onRequest(donation)} disabled={donation.solicitado}>
