    ...
    <div className={styles.pageContainer}>
      ...
      <div className={styles.contentWrapper}>
        ...
        <div className={styles.topShieldArea}>
          <div className={styles.shieldCircle}>
            <img
              ...
              alt=""
              className={styles.mainShieldIcon}
            />
          </div>
        </div>
        ...
        <div className={styles.welcomeCard}>
          <p>
            Bienvenido a <strong>ECO CANJE</strong>, la plataforma universitaria
            de donaciones solidarias comprometida con la sostenibilidad y el
            reciclaje. Al acceder a nuestros servicios, aceptas los siguientes
            términos y condiciones. Te invitamos a leerlos con atención para
            conocer tus derechos y responsabilidades como miembro de nuestra
            comunidad.
          </p>
        </div>
        ...
        <div className={styles.ctaBanner}>
          <div className={styles.ctaCheckIconWrap}>
            <img
              ...
              alt=""
              className={styles.ctaCheckIcon}
            />
          </div>
          <h3 className={styles.ctaTitle}>¿Tienes alguna pregunta?</h3>
          <p className={styles.ctaSubtitle}>
            Si no encuentras respuesta a tus dudas sobre estos términos, nuestro
