...
import { getUserLevel, LEVEL_COLORS } from "../../utils/levels";
...
// Reemplaza los emojis 🏅 🥈 🥉 🎖️ del ranking de Top Contributors
function IconMedal({ color = "#10b981", ...props }) {
  return (
...
const MEDAL_COLORS = ["#facc15", "#c0c0c0", "#cd7f32", "#10b981", "#10b981"];
...
export default function CommunityPage() {
  ...
  // Eventos en tiempo real (solo próximos, no muestra eventos pasados)
  useEffect(() => {
  ...
  // Todos los usuarios en tiempo real (conteo de miembros + niveles + top contribuidores)
  useEffect(() => {
    const unsubscribe = onSnapshot(
      collection(db, "users"),
      (snap) => {
  ...
  // Todas las donaciones en tiempo real (para calcular puntos/nivel real de cada usuario)
  useEffect(() => {
    const unsubscribe = onSnapshot(
      ...
      (err) => console.error("Error leyendo donaciones:", err),
    );
    return () => unsubscribe();
  }, []);
      ...
      <main className={styles.container}>
        ...
        <section className={styles.stats}>
          ...
          <div className={styles.statCard}>
            ...
            <h2>{forums.reduce((s, f) => s + (f.likes?.length || 0), 0)}</h2>
            <span>Impactos</span>
          </div>
        </section>
        ...
        <section className={styles.grid}>
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.card}>
              <h2 className={styles.cardTitle}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                  <path
                    d="M12 15C15.3 15 18 12.3 18 9V3H6V9C6 12.3 8.7 15 12 15Z"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinejoin="round"
                  />
                  ...
                  />
                  <path
                    d="M6 6H3V8C3 10 4.5 11.5 6.5 11.5"
                    stroke="currentColor"
                    strokeWidth="2"
                  />
                  <path
                    d="M18 6H21V8C21 10 19.5 11.5 17.5 11.5"
                    stroke="currentColor"
                    strokeWidth="2"
                  />
                </svg>
                    ...
                    <div className={styles.levelCard} key={u.id}>
                      ...
                      <div className={styles.levelInfo}>
                        ...
                        <span
                          ...
                          style={{
                            background:
                              (LEVEL_COLORS[u.userLevel] || "#10b981") + "22",
                            color: LEVEL_COLORS[u.userLevel] || "#10b981",
                            border: `1px solid ${LEVEL_COLORS[u.userLevel] || "#10b981"}55`,
                          }}
                        >
                          {u.userLevel}
                        </span>
          ...
          <aside className={styles.sidebar}>
            ...
            <div className={styles.card}>
              ...
              {events.map((event) => {
                const attending =
                  !isGuest && (event.attendees || []).includes(user?.uid);
                return (
                  <div className={styles.eventItem} key={event.id}>
                    ...
                    <button
                      ...
                      className={
                        attending ? styles.btnAttending : styles.btnPrimary
                      }
