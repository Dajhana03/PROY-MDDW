...
export default function PublishPage() {
  ...
  const handlePublish = () => {
    ...
    const existing = JSON.parse(
      window.localStorage.getItem("ecocanje_posts") || "[]",
    );
    window.localStorage.setItem(
      "ecocanje_posts",
      JSON.stringify([...existing, publication]),
    );
          ...
          <div className="modal-card">
            ...
            <div className="modal-body">
              ...
              <div className="preview-row">
                <span className="preview-key">Tipo</span>
                <span className="preview-val">
                  {typeOptions.find((item) => item.value === type)?.label}
                </span>
              </div>
              <div className="preview-row">
                <span className="preview-key">Título</span>
                <span className="preview-val">{title || "—"}</span>
              </div>
              <div className="preview-row">
                <span className="preview-key">Descripción</span>
                <span className="preview-val">{description || "—"}</span>
              </div>
              <div className="preview-row">
                <span className="preview-key">Cantidad</span>
                <span className="preview-val">{quantity}</span>
              </div>
              <div className="preview-row">
                <span className="preview-key">Condición</span>
                <span className="preview-val">{condition}</span>
              </div>
              <div className="preview-row">
                <span className="preview-key">Ubicación</span>
                <span className="preview-val">{location || "—"}</span>
              </div>
              <div className="preview-row">
                <span className="preview-key">Fecha</span>
                <span className="preview-val">{date || "—"}</span>
              </div>
              <div className="preview-row">
                <span className="preview-key">Hora</span>
                <span className="preview-val">{time || "—"}</span>
              </div>
            </div>
          </div>
        </div>
